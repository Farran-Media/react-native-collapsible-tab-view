...
export const Container = /*#__PURE__*/React.memo(/*#__PURE__*/React.forwardRef(({
  ...
  const propagateTabChange = React.useCallback(change => {
    onTabChange === null || onTabChange === void 0 || onTabChange(change);
    onIndexChange === null || onIndexChange === void 0 || onIndexChange(change.index);
  ...
  const onTabPress = React.useCallback(name => {
    ...
    if (name === focusedTab.value) {
      ...
      (_containerRef$current = containerRef.current) === null || _containerRef$current === void 0 || _containerRef$current.setPage(i);
    }
  },
