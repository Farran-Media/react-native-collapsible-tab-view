...
const ensureLegendList = () => {
  ...
  try {
    ...
    AnimatedLegendList = _reactNativeReanimated.default.createAnimatedComponent(legendListModule.LegendList);
  } catch {
...
const LegendListMemo = /*#__PURE__*/_react.default.memo(/*#__PURE__*/_react.default.forwardRef((props, passRef) => {
  ensureLegendList();
  return AnimatedLegendList ? /*#__PURE__*/_react.default.createElement(AnimatedLegendList, _extends({
    ref: passRef
...
function LegendListImpl({
  ...
  const memoContentContainerStyle = _react.default.useMemo(() => [_contentContainerStyle, contentContainerStyle], [_contentContainerStyle, contentContainerStyle]);
